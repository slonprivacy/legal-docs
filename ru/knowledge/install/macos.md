...
<section class="app-tab-panel is-active" aria-labelledby="macos-incy-title">
  <h1 id="macos-incy-title">Установка Slon Privacy на macOS</h1>
  ...
  <div class="guide-note">
    ...
    <a href="https://my.slonprivacy.app/login" target="_blank" rel="noopener noreferrer">Перейти в личный кабинет →</a>
  </div>
  ...
  <section class="guide-step">
    ...
    <div class="guide-step-content">
      <h2>Скачайте INCY</h2>
      <p>Войдите в <a href="https://my.slonprivacy.app/login" target="_blank" rel="noopener noreferrer">личный кабинет Slon Privacy</a>, нажмите <strong>«Подключить устройство»</strong> и выберите <strong>macOS</strong>.</p>
