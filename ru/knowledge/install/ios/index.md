...
<div class="app-tabs" data-app-tabs>
  ...
  <section id="happ-panel" class="app-tab-panel is-active" role="tabpanel">
    <h2>Happ</h2>
    <p><strong>Установите Happ, добавьте подписку Slon Privacy и подключитесь к серверу. Настройка обычно занимает 2–3 минуты.</strong></p>

    <div class="guide-note">
      <strong>Перед началом</strong>
      <p>Убедитесь, что подписка Slon Privacy активна, а iPhone или iPad подключён к интернету.</p>
      <a href="https://t.me/slon_privacy_bot" target="_blank" rel="noopener noreferrer">Как оформить подписку →</a>
    </div>
    ...
    <section class="guide-step">
      ...
      <div class="guide-step-content">
        <h2>Откройте установку устройства</h2>
        <p>Войдите в личный кабинет через <a href="https://t.me/slon_privacy_bot" target="_blank" rel="noopener noreferrer">Telegram-бота</a> или на сайте <a href="https://my.slonprivacy.app/login" target="_blank" rel="noopener noreferrer">my.slonprivacy.app</a>. На главной странице нажмите <strong>«Подключить устройство»</strong>.</p>
    ...
    <section class="guide-step">
      ...
      <div class="guide-step-content">
        ...
        <img class="guide-image" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/happ/03-add-subscription.webp" alt="Кнопка «Добавить подписку» на странице установки Slon Privacy" loading="lazy">
    ...
    <section class="guide-step">
      ...
      <div class="guide-step-content">
        ...
        <img class="guide-image" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/happ/04-connect.webp" alt="Список серверов и кнопка подключения в приложении Happ на iOS" loading="lazy">
    ...
    <section class="guide-faq" aria-labelledby="happ-faq-title">
      ...
      <details>
        ...
        <p>Нажмите кнопку обновления рядом с названием подписки. Если серверы не появились, добавьте подписку повторно.</p>
        <img class="guide-image guide-image-small" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/happ/05-refresh-subscription.webp" alt="Кнопка обновления серверов в Happ на iOS" loading="lazy">
      </details>
  ...
  <section id="incy-panel" class="app-tab-panel" role="tabpanel">
    <h2>INCY</h2>
    <p><strong>Установите INCY, добавьте подписку Slon Privacy и подключитесь к серверу. Настройка обычно занимает 2–3 минуты.</strong></p>
    ...
    <section class="guide-step">
      ...
      <div class="guide-step-content">
        ...
        <img class="guide-image" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/incy/03-add-subscription.webp" alt="Кнопка «Добавить подписку» на странице установки Slon Privacy" loading="lazy">
    ...
    <section class="guide-step">
      ...
      <div class="guide-step-content">
        ...
        <img class="guide-image" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/incy/04-connect.webp" alt="Главный экран INCY с кнопкой подключения и списком серверов Slon Privacy на iOS" loading="lazy">
    ...
    <section class="guide-faq" aria-labelledby="incy-faq-title">
      ...
      <details>
        <summary>Подписка добавилась, но серверов нет</summary>
        <p>Нажмите кнопку обновления рядом с названием подписки <strong>SLON Privacy</strong>. Если серверы не появились, добавьте подписку повторно.</p>
        <img class="guide-image guide-image-small" src="{{ site.baseurl }}/assets/img/knowledge-base/ios/incy/05-refresh-subscription.webp" alt="Кнопка обновления подписки в INCY на iOS" loading="lazy">
      </details>
